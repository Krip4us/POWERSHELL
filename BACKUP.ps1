...
$Destination="F:\DESKTOP\admin FILES" #Copy the Files to this Location
$Versions="2" #How many of the last Backups you want to keep
$BackupDirs="C:\Desktop", "C:\Program Files (x86)\", "C:\Users", "C:\Program Files" #What Folders you want to backup
$ExcludeDirs="C:\Pictures" #This list of Directories will not be copied
$LogName="MICROSOFT" #Log Name
...
$Backupdir=$Destination +"C:\SQLServer2017Media"+ (Get-Date -format yyyy-MM-dd)+"-"+(Get-Random -Maximum 100000)+"\"
